...
function Header() {
  ...
  return (
    <header className="z-[999] relative ">
      <motion.div
        className="left-1/2 h-[4.5rem] w-full rounded-none
    ...
    dark:bg-gray-950 dark:border-black/40 dark:bg-opacity-75"
      ...
      <nav
        className="fixed flex top-[0.15rem] left-1/2 h-12 -translate-x-1/2 py-2 
      sm:top-[1.7rem] sm:h-[initial] sm:py-0"
      >
        <ul
          className="flex w-[22rem] flex-wrap items-center justify-center gay-y-1 text-[0.9rem] font-medium text-gray-500
