	...
	return (
		...
		>
			...
			<p className='mb-3'>
				...
				Sports; For me? It has always been Computers. I love building stuff,
				learning new things, meeting new people. I just love tech in general.
				So, if you have something cool to build feel free to reach out!!
			</p>
